...
async function validarArchivo(){
    ...
    if(!extPer.exec(ruta)){
        ...
        if(filax && filax.length!=3){
            ...
            document.getElementById('muestraArchivo').innerHTML= 
            '<span class="text-center mb-4"><br>Vista Previa<br>Lista de Alumnos</span>'+
            '<div class="row align-items-center justify-content-center text-center">'+
                ...
                '</a>'+
                '<a class="col-xs-2 nav-link active active-pro mt-1 text-center" href="">'+
                    '<span class="material-icons text-success" title="Subir grupo">post_add</span>'+
                '</a>'+
            '</div>'
